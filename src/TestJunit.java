...
public class TestJunit {
	...
	public void testColor() {
		...
		// initial
		rt1 = i1.getRBTree();
		assertEquals(BLACK, rt1.root.color);

		// first insertion
		i1.intervalInsert(0, 4); 
		rt1 = i1.getRBTree();
		assertEquals(BLACK, rt1.root.color);
		assertEquals(RED, rt1.root.right.color);

		// second insertion
		i1.intervalInsert(1, 6); 
		rt1 = i1.getRBTree();
		assertEquals(BLACK, rt1.root.color);
		assertEquals(BLACK, rt1.root.left.color);
		assertEquals(BLACK, rt1.root.right.color);
		assertEquals(RED, rt1.root.right.right.color);
		...
		assertEquals(BLACK, rt1.root.left.color);
		assertEquals(RED, rt1.root.right.color);
		assertEquals(BLACK, rt1.root.right.right.color);
		assertEquals(BLACK, rt1.root.right.left.color);
		assertEquals(RED, rt1.root.right.right.right.color);

		// fourth insertion
		i1.intervalInsert(7, 11);
		rt1 = i1.getRBTree();
		assertEquals(BLACK, rt1.root.color);
		assertEquals(RED, rt1.root.left.color);
		assertEquals(BLACK, rt1.root.left.left.color);
		assertEquals(BLACK, rt1.root.left.right.color);
		assertEquals(RED, rt1.root.right.color);
		assertEquals(BLACK, rt1.root.right.left.color);
		assertEquals(BLACK, rt1.root.right.right.color);
		assertEquals(RED, rt1.root.right.right.right.color);
	...
	public void testEmax() {
		...
		assertEquals(rt1.nil.key, rt1.root.right.getEmax().getValue());
		assertEquals(rt1.nil.key, rt1.root.right.left.getEmax().getValue());
		assertEquals(rt1.nil.key, rt1.root.right.right.getEmax().getValue());
		assertEquals(rt1.nil.key, rt1.root.right.right.right.getEmax().getValue());
